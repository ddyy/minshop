 ...
 *
 * AUTH_SECRET signs a short-lived, single-purpose HMAC generated by
 * scripts/deploy.mjs. This route deliberately lives outside /api/admin because
 * Cloudflare Access can intercept that namespace before the Worker runs.
 */
